<template>
    <v-app id="app">
        <v-main>
            <v-container>
                <div>
                    <td>▶ PCS쿠폰발행_PCS_P4(카테고리)(승인포함)(GMKT)</td>
                </div>
                <div>
                    <h2 class=""><span>PCS P4 Category 쿠폰 신규 등록(GMKT)</span></h2>
                            ...
                            <tr>
                                ...
                                <td>
                                    <v-row>
                                        ...
                                        <v-col>
                                            <v-select v-model="m_time2" :items="minutes2" single-line>
                                            </v-select>
                                        </v-col>
                                    </v-row>
                                </td>
                ...
                <div id="">
                    ...
                    <v-simple-table class="">
                        <tbody>
                            <tr>
                                <th>PCS 쿠폰 타입</th>
                                <td colspan="3">PCS P4 카테고리 내 셀러쿠폰</td>
                            </tr>
                            <tr>
                                <th>기간</th>
                                <td>
                                    <v-row>
                                        <v-col cols="12" lg="4">
                                            <v-menu id="s_date2" ref="menu3" v-model="menu3"
                                                ...
                                                transition="scale-transition" offset-y min-width="290px">
                                                <template v-slot:activator="{ on, attrs }">
                                                    <v-text-field v-model="s_date2" append-icon="mdi-calendar" readonly
                                                        v-bind="attrs" v-on="on"></v-text-field>
                                                </template>
                                        ...
                                        <v-col cols="2">
                                            <v-select v-model="m_time3" :items="minutes3" menu-props="auto" single-line>
                                            </v-select>
                                        </v-col>
                                    ...
                                    <v-row>
                                        <v-col cols="12" lg="4">
                                            <v-menu id="s_date_searching2" ref="menu7" v-model="menu7"
                                                :close-on-content-click="false" :return-value.sync="s_date_searching2"
                                                transition="scale-transition" offset-y min-width="290px">
                                                <template v-slot:activator="{ on, attrs }">
                                                    <v-text-field v-model="s_date_searching2" append-icon="mdi-calendar"
                                        ...
                                        <v-col cols="12" lg="4">
                                            <v-menu id="e_date_searching2" ref="menu8" v-model="menu8"
                                                :close-on-content-click="false" :return-value.sync="e_date_searching1"
                                                transition="scale-transition" offset-y min-width="290px">
                                                <template v-slot:activator="{ on, attrs }">
                                                    <v-text-field v-model="e_date_searching2" append-icon="mdi-calendar"
                                                        readonly v-bind="attrs" v-on="on"></v-text-field>
                                                </template>
...
export default {
    data() {
        const dt = new Date();
        return {
            s_date2: dt.toISOString().substring(0, 10),  //menu3
            e_date2: dt.toISOString().substring(0, 10), //menu4
