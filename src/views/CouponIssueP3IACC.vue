<template>
    <v-app id="app">
        <v-main>
            <v-container>
                <div>
                    <td>▶ PCS쿠폰발행_PCS_P3(카탈로그)(승인포함)(IACC)</td>
                </div>
                <div>
                    <h2><span>PCS P3 쿠폰 신규 등록(IACC)</span></h2>
                    <v-form>
                        <v-row lazy-validation>
                            <v-simple-table>
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row">발행옵션</th>
                                        <td colspan="3">
                                            <span name="chkIssueOption"><input id="chkIssueOption" type="checkbox"
                                                    name="chkIssueOption"><label for="chkIssueOption">평일야간(12:30 ~ 00:30)
                                                    발행</label></span>
                                            <span name="chkHoliday"><input id="chkHoliday" type="checkbox"
                                                    name="chkHoliday"><label for="chkHoliday">공휴일 발행</label></span>
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="register">
                        ...
                        -->
                        <v-btn id="pcsCpnIaccCatP3" @click="PcsCpnIaccCatP3_Register" @keyup.enter="PcsCpnIaccCatP3_Register">
                            등록
                        </v-btn>
                    </div>
                    ...
                    <div>
                        ...
                        <div style="text-align:right">
                            ...
                            <v-btn id="pcsCpnIaccCatP3Select" @click="PcsCpnIaccCatP3_Select" @keyup.enter="PcsCpnIaccCatP3_Select">
                                조회
                            </v-btn>
                            <v-btn depressed>
                                승인
                            ...
                            <v-simple-table class="">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <v-col cols="6">
                                                <v-select v-model="assign" :items="assign_status" menu-props="auto" single-line>
                                                </v-select>
                                            </v-col>
                                        </td>
...
export default {
        ...
        return {
            ...
            */
            ...
            headers: [
                ...
                { text: '관리번호', align: 'center', sortable: false, value:'groupNo'},
                { text: '내부관리명', align: 'center', sortable: false, value:'groupName'},
                ...
                { text: '야간', align: 'center', sortable: false, value:''},
                { text: '공휴일', align: 'center', sortable: false, value:''},
    ...
    methods: {
        ...
        async PcsCpnIaccCatP3_Register(){

            // var varTxtGroupName = '';
            // var varTxtTr = '';

            alert("PcsCpnIaccCatP3_Register Click");
            ...
            if (this.txtGroupName.length == 0){
                ...
                if (this.txtTR.length == 0){
                    ...
                    if ((this.txtTR < -50) || (this.txtTR > 50)){
                        ...
                        // submit
                        http.post('/postPCSP3ManageRegist', null, {
                            params:{
                        ...
                        .then(res=>{
                            console.log("/postPCSP3ManageRegist Vue JS Call Success");
                            console.log(res);
                        })
                        .catch(e=>{
                            console.log("/postPCSP3ManageRegist Vue JS Call Failure");
                            console.log(e);
                        })
                    }
                }
        ...
        async PcsCpnIaccCatP3_Select(){
            alert("PcsCpnIaccCatP3_Select Click");
            ...
            if (this.txtSelectGroupName.length == 0){
                ...
                // submit
                http.post('/postPCSP3ManageSelect', null, {
                    params:{
                ...
                .then(res=>{
                    ...
                    console.log("/postPCSP3ManageSelect Vue JS Call Success");
                    console.log("res = ");
                ...
                .catch(e=>{
                    console.log("/postPCSP3ManageSelect Vue JS Call Failure");
                    console.log(e);
                })
            }
        }
